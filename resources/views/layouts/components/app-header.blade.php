                        ...
                        <div class="d-flex order-lg-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading border-bottom">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <span class="badge bg-danger-transparent header-badge text-danger">Hurry
                                                    Up!</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="header-dropdown-list shopping-list">
                                        <div class="dropdown-item  p-4">
                                            <a href="javascript:void(0);" class="d-flex">
                                                ...
                                                <div class="">
                                                    ...
                                                    <span class="text-dark">Status: <span class="text-success">In
                                                            Stock</span></span>
                                        ...
                                        <div class="dropdown-item  p-4">
                                            <a href="javascript:void(0);" class="d-flex">
                                                ...
                                                <div class="">
                                                    ...
                                                    <span class="text-dark">Status: <span class="text-success">Out
                                                            Stock</span></span>
                                        ...
                                        <div class="dropdown-item  p-4">
                                            <a href="javascript:void(0);" class="d-flex">
                                                ...
                                                <div class="">
                                                    <h6 class="mb-1 text-dark fw-semibold fs-14">Stylish Mens Shoes
                                                    </h6>
                                                    <span class="text-dark">Status: <span class="text-success">In
                                                            Stock</span></span>
                                                    <p class="fs-13 text-muted mb-0">Quantity: 06</p>
                                        ...
                                        <div class="dropdown-item  p-4">
                                            <a href="javascript:void(0);" class="d-flex">
                                                ...
                                                <div class="">
                                                    <h6 class="mb-1 text-dark fw-semibold fs-14">Wireless headphones
                                                    </h6>
                                                    <span class="text-dark">Status: <span class="text-success">In
                                                            Stock</span></span>
                                                    <p class="fs-13 text-muted mb-0">Quantity: 05</p>
                                    ...
                                    <div class="dropdown-footer p-4">
                                        <a class="btn btn-primary btn-pill w-sm btn-sm py-2 btn-block fs-14"
                                            href="javascript:void(0);">View Cart</a>
                            ...
                            {{-- <div class="dropdown  d-flex notifications">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="notifications-menu">
                                        ...
                                        <a class="dropdown-item d-flex" href="javascript:void(0);">
                                            <div
                                                class="me-3 notifyimg  bg-secondary brround box-shadow-secondary my-auto">
                            ...
                            {{-- <div class="dropdown  d-flex message">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="dropdown-footer p-4">
                                        <a class="btn btn-primary btn-pill w-sm btn-sm py-2 btn-block fs-14"
                                            href="javascript:void(0);">See All Messages</a>
                                    </div>
                                </div>
                            </div> --}}
                            <!-- MESSAGE-BOX -->
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown"
                                    ...
                                    @if (Auth::user())
                                        @if (isset(Auth::user()->picture) && !empty(Auth::user()->picture))
                                            <img src="{{ asset(Auth::user()->picture) }}" alt="profile-user"
                                                class="avatar  profile-user brround cover-image">
                                        @else
                                            <img src="{{ asset('build/assets/images/users/11.jpg') }}"
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            <h5 class="text-dark mb-0 fs-14 fw-semibold">{{ Auth::user()->user_name  ?? null}}
                                            </h5>
